...
module.exports = new Script({
    ...
    start: {
        receive: (bot) => {
            return bot.say('Welcome to The Design House, I am The Design Bot 🤖  Nice to meet you! I can already tell that we are going to be great friends! To begin, please say GO.')
                .then(() => 'speak');
        }
    },
